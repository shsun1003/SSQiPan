...
(9) Supports a few color themes and also lets you create your own board images by saving square png image files in the "\Resources" folder and then select in the Setting dialog box.

(10) Supports localization and 4 languages other than English: Simplified Chinese, Traditional Chinese, Japanese and Korean. At this moment, only UI controls are localized. More works will be done with messages in the near future. Please note: Japanese and Korean text items are generated by AI and may contain inaccuracy.
